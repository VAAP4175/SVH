...
$sql="SELECT id_alumno,nombre_completo, usuario FROM alumnos";
...
<?php
    ...
    while($row=$result->fetch_assoc()){
        ...
        <td><a href='eliminar.php?id=".$row['id_alumno']."'>Eliminar</a>
        <td><a href='prueba_actualizar.php?id=".$row['id_alumno']."'>Actualizar</a>
        </tr>";
        }
    }
?>
